...
const musicbrainz_1 = require("../lib/musicbrainz");
const prisma = new client_1.PrismaClient();
async function backfillAlbumArt(options = {}) {
    ...
    for (let i = 0; i < songs.length; i++) {
        ...
        try {
            ...
            const metadata = await (0, musicbrainz_1.fetchSongMetadata)(song.artist, song.title);
            if (!metadata) {
